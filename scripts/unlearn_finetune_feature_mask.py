...
def roi_masking(img, boxes, unlearn_obj, margin=2):
    ...
    for batch_idx, batch in enumerate(tqdm.tqdm(train_loader)): 
      ...
      if t % args.num_iterations == 0:
        ...
        checkpoint_path_latest = os.path.join(args.output_dir,
                              f'{args.checkpoint_name}_model_ft_obj_{args.specific_obj}_{args.data_lot_idx}_feature_mask.pt')
