...
def main(args):
  ...
  # args.checkpoint_start_from = ''  # path pre-trained model
    ...
    for batch in tqdm.tqdm(train_loader): 
      ...
      if t % args.num_iterations == 0:
        ...
        checkpoint_path_latest = os.path.join(args.output_dir,
                              f'{args.checkpoint_name}_model_ft_obj_{args.specific_obj}_{args.data_lot_idx}.pt')
