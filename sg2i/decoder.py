...
from sg2i.layers import get_normalization_2d
from sg2i.layers import get_activation

from sg2i.utils import seed_everthing

from sg2i.SPADE.normalization import SPADE
...
class DecoderNetwork(nn.Module):
  ...
  def forward(self, layout):
    ...
    for mod in self.decoder_modules:
      # feats = F.upsample(feats, scale_factor=2, mode='nearest')  # discarded!
